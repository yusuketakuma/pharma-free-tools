...
const { managementLoop, getCurrentState, setModeManually } = require('./token-manager-coordinator-v4');
...
// スナップショット取得ジョブ
const SNAPSHOT_JOB = {
  id: 'token-management-snapshot-v4',
  name: 'token-management-snapshot-v4',
  schedule: {
    kind: 'cron',
    expr: '*/15 * * * *',
    tz: 'Asia/Tokyo'
...
const EVALUATION_JOB = {
  id: 'token-management-evaluation-v4',
  name: 'token-management-evaluation-v4',
  schedule: {
    kind: 'cron',
    expr: '*/15 * * * *',
    tz: 'Asia/Tokyo'
...
// メイン実行関数
async function main() {
  console.log('トークン管理システム v4 セットアップを開始...');
