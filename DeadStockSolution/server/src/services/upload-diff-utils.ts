...
/**
 * Compute optimal batch size based on total item count.
 * Uses linear scaling: totalCount / 100, clamped to [500, 5000].
 * This reduces transaction count for large uploads (100k+ rows).
 */
export function computeBatchSize(totalCount: number): number {
